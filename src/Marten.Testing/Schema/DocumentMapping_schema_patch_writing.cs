    ...
    public class DocumentMapping_schema_patch_writing : IntegratedFixture
    {
        ...
        public void can_revert_indexes_that_changed()
        {
            ...
            }))
            {
                ...
                patch.RollbackDDL.ShouldContain("CREATE INDEX mt_doc_user_idx_user_name ON public.mt_doc_user USING btree (user_name);");
        ...
        public void can_revert_indexes_that_changed_in_non_public_schema()
        {
            ...
            }))
            {
                ...
                //CREATE INDEX mt_doc_user_idx_user_name ON public.mt_doc_user USING btree (user_name);
